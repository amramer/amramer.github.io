...
- Build <strong>end-to-end ML pipelines</strong>: data → training → evaluation → visualization  
- Optimize models using <strong>systematic experimentation</strong> (Weights & Biases, sweeps)  

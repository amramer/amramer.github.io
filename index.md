...
<div class="page-with-toc">
  ...
  <aside class="toc-sidebar">
    ...
    <ul>
      <li><a href="#featured-projects" class="toc-section">Featured Projects</a></li>
      <ul class="toc-sub">
        <li><a href="#masters-thesis">Master’s Thesis</a></li>
        <li><a href="#badminton-visionai">Badminton VisionAI</a></li>
      </ul>

      <li><a href="#other-projects" class="toc-section">Other Projects</a></li>
      <ul class="toc-sub">
      ...
      <li><a href="#technical-profile" class="toc-section">Technical Profile</a></li>
      <li><a href="#beyond-work" class="toc-section">Beyond Work</a></li>
      <li><a href="#contact" class="toc-section">Contact</a></li>
    </ul>
  </aside>
  ...
  <main class="portfolio-main">
    ...
    <div id="what-i-do" class="section-anchor"></div>
    ...
    <div id="featured-projects" class="section-anchor"></div>

    # ⭐ Featured Projects

    <div id="masters-thesis" class="section-anchor"></div>
    ...
    <div id="badminton-visionai" class="section-anchor"></div>
    ...
    **Reporting:** ReportLab PDF Export
    ...
    <div id="other-projects" class="section-anchor"></div>

    # 🧠 Other Projects

    <div id="autonomous-driving" class="section-anchor"></div>
    ...
    **Tech Used:** PyTorch · Fastai · Semantic Segmentation · Hyperparameter Optimization · Experiment Tracking
    ...
    <div id="medical-imaging" class="section-anchor"></div>
    ...
    **Tech Used:** PyTorch · MONAI · 3D SegResNet · Multi-modal MRI  
    ...
    <div id="vision-language-models" class="section-anchor"></div>
    ...
    **Tech Used:**  
    ...
    <div id="conversational-ai" class="section-anchor"></div>
    ...
    **Status:** 🚧 Ongoing
    ...
    <div id="technical-profile" class="section-anchor"></div>
    ...
    <div id="beyond-work" class="section-anchor"></div>
